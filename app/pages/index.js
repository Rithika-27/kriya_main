  ...
  return (
    <div className="min-h-screen bg-blue-50 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center space-x-10 animate-scroll h-1/4">
        <h1 className="text-[8vw] font-semibold text-violet-700">Event</h1>
        <Image
        ...
        />
        <h1 className="text-[8vw] font-semibold text-violet-700">Strategies</h1>
      </div>
      ...
      <div className="flex items-center space-x-10 animate-scroll-reverse h-1/4">
        <Image
          ...
          className="rounded-lg"
        />
        <h1 className="text-[8vw] font-semibold text-violet-700">Marketing</h1>
      </div>
      ...
      <div className="flex items-center space-x-10 animate-scroll-reverse h-1/4">
        <h1 className="text-[8vw] font-semibold text-violet-700">Engagement</h1>
        <Image
